...
function AdminFileUpload() {
    ...
    const fetchProjectFiles = async () => {
        try {
            const response = await axios.get(
                `https://brainwavelabsbackend-jnzx.onrender.com/api/admin/${projectCode}/projectFiles`
            );
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await axios.post(
                `https://brainwavelabsbackend-jnzx.onrender.com/api/admin/project/upload`,
                formData,
                {
                    headers: {
    ...
    const handleViewFile = async (fileName) => {
        try {
            setLoading(true);
            const response = await axios.get(
                `https://brainwavelabsbackend-jnzx.onrender.com/api/admin/files/${fileName}`,
                { responseType: "blob" }
            );
