...
function ProjectProfile() {
    ...
    const fetchProjectDetails = async () => {
      try {
        const res = await axios.get(
          `https://brainwavelabsbackend-jnzx.onrender.com/api/admin/project/${projectCode}`
        );
        setProject(res.data);
  ...
  const handleSearchInvestigators = async (e) => {
    ...
    if (searchText) {
      try {
        ...
        const response = await axios.get('https://brainwavelabsbackend-jnzx.onrender.com/api/findInvestigator/', {
  ...
  const handleDeleteInvestigator = async (name, email) => {
    try {
      ...
      const res = await axios.post(`https://brainwavelabsbackend-jnzx.onrender.com/api/admin/project/deleteInvestigator`, deleteData);
      setProject(prev => ({
        ...prev,
