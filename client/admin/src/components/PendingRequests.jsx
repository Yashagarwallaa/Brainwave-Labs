...
function PendingRequests({ adminEmail }) {
    ...
    useEffect(() => {
        async function displayRequests() {
            try {
                const res = await axios.get('https://brainwavelabsbackend-jnzx.onrender.com/api/admin/pendingRequests', {
    ...
    const handleAccept = async (projectCode, fieldToUpdate, newValue, requestId) => {
        try {
            await axios.put(`https://brainwavelabsbackend-jnzx.onrender.com/api/admin/acceptRequest`, {
    ...
    const handleReject = async (requestId) => {
        try {
            await axios.post('https://brainwavelabsbackend-jnzx.onrender.com/api/admin/rejectRequest', {
                requestId
            });
